<div id="def-footer">
	...
	<!-- /ROOT/app/cls/WET/utweb/v4_0_14/static/footer-en.html -->
	        ...
	        <div class="row">
	            ...
	            <div class="col-sm-3 col-lg-3 brdr-lft">
	                <section>
	                    <h3>Feedback</h3>
	                    <p>
	                        <a href="http://www.canada.ca/en/contact/feedback.html"><img src="http://templates.services.gc.ca/app/cls/wet/gcweb/v4_0_17/assets/feedback.png" alt="Feedback about this Web site"></a>
	                    </p>
	                </section>
	                <section>
	                    <h3>Social media</h3>
	                    <p>
	                        <a href="http://www.canada.ca/en/social"><img src="http://templates.services.gc.ca/app/cls/wet/gcweb/v4_0_17/assets/social.png" alt="Social media"></a>
	                    </p>
	                </section>
	                <section>
	                    <h3>Mobile centre</h3>
	                    <p>
	                        <a href="http://www.canada.ca/en/mobile"><img src="http://templates.services.gc.ca/app/cls/wet/gcweb/v4_0_17/assets/mobile.png" alt="Mobile centre"></a>
	                    </p>
	                </section>
	            </div>
	        </div>
	        ...
	        <div class="container">
	            <div class="row">
	                ...
	                <div class="col-xs-6 col-md-12 text-right">
	                    <object type="image/svg+xml" tabindex="-1" role="img" data="http://templates.services.gc.ca/app/cls/wet/gcweb/v4_0_17/assets/wmms-blk.svg" aria-label="Symbol of the Government of Canada"></object>
	                </div>
	            </div>
	        </div>
	    </div>
